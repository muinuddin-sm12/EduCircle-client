          ...
          <form onSubmit={handlePasswordSignIn}>
            <div className='mt-4'>
              ...
              <input
                ...
                autoComplete='email'
                name='email'
                className='block w-full px-4 py-2 text-gray-700 rounded-lg  border  focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300'
                type='email'
              />
            </div>

...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-369px)] my-20">
      <div className="flex w-full mx-auto overflow-hidden border rounded-lg shadow-lg  lg:max-w-md ">
          ...
          <form onSubmit={handlePasswordSignIn}>
            <div className="mt-4">
              ...
              <input
                ...
                autoComplete="email"
                name="email"
                className="block w-full px-4 py-2 rounded-lg  border  focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300"
                type="email"
              />
            </div>
            ...
            <div className="mt-6">
              <button
                type="submit"
                className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#1979C1] rounded-lg"
              >
                Sign In
              </button>
            </div>

  ...
  return (
    <div className="py-16 mx-auto px-4 md:px-10 bg-base-200 my-6 lg:my-20">
      ...
      <div className="flex flex-wrap justify-center gap-6 max-w-[936px] mx-auto">
        <div  className="flex flex-col h-[250px] w-[200px] justify-between items-center px-2 py-8 rounded-2xl border border-[#1979C1] hover:bg-base-100 hover:border-[#FCB138] duration-200">
